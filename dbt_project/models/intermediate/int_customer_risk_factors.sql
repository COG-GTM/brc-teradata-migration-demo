...
risk_factors as (
    ...
    select
        ...
        -- generate_surrogate_key returns text; extract integer from hex for modulo
        {{ hash_to_int_bucket(dbt_utils.generate_surrogate_key(['ca.customer_id']), 10) }} as risk_bucket
